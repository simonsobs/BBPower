...
for ii, (i1, i2) in enumerate(zip(indices_tr[0], indices_tr[1])):
    ...
    cl_type = f'cl_{p1}{p2}'
    s_d.add_ell_cl(cl_type, n1, n2, leff, bpw_freq_sig[i1, i2, :], window=s_wins)  # noqa
    s_f.add_ell_cl(cl_type, n1, n2, leff, bpw_freq_sig[i1, i2, :], window=s_wins)  # noqa
    s_n.add_ell_cl(cl_type, n1, n2, leff, bpw_freq_noi[i1, i2, :], window=s_wins)  # noqa
