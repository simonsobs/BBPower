import numpy as np
from utils_SO_2023 import *
import noise_calc as nc
import sacc
import sys

# prefix: where to save theory spectra
prefix_out = sys.argv[1]

# Bandpasses
bpss = {n: Bpass(n, f'/pscratch/sd/k/kwolz/BBPower/examples/data/bandpasses/{n}_delta.txt') for n in band_names}
